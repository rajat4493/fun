    ...
    <main className="min-h-screen bg-[#030303] px-6 py-10 text-white">
      <section className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-5 text-white/60">
          ...
          <p>F.U.N may store recommendation runs so we can improve matching quality. This can include your mood tags, avoidances, time, energy, language preference, country, selected platforms, interpreted intent, recommended title, availability result, confidence score, and pseudonymous session id.</p>
